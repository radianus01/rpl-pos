...
<body id="page-top" class="<?= $this->uri->segment(1) == 'app' ? 'sidebar-collapse' : null ?>">
    ...
    <div id="wrapper" class="">
        ...
        <ul class="navbar-nav  bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
            ...
            <li <?= $this->uri->segment(1) == 'transaksi/getTrsantunda'  ? 'class=" nav-item  active "' : 'class="nav-item "' ?>>
                <a class=" nav-link" href="<?= base_url('transaksi/getTrsantunda') ?>">
                    <i class="fas fa-pause-circle"></i>
                    <span>Transaksi Tunda</span></a>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Point Of Sale <?= date('Y'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
